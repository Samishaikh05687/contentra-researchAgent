...
const CTA: React.FC = () => (
    <div className="relative overflow-hidden rounded-3xl border bg-black bg-opacity-30  text-primary-foreground">
        <div className="relative p-10 md:p-16 grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
                <h3 className="text-3xl md:text-4xl font-medium leading-tight">
                    Supercharge Your <span className="text-purple-600">Workflow</span> with AI 🚀
                </h3>
            ...
            <div className="relative">
                ...
                <section id="about" className="py-20 relative ">
                    <div className="flex justify-center mb-14 items-center">
                        <div className="inline-flex justify-center items-center gap-2 rounded-full border px-5 py-2 text-sm tracking-wider uppercase text-muted-foreground">
                            <Sparkles className="h-3.5 w-3.5" /> About Us
                        </div>
                    </div>
                    <div className="max-w-6xl  mx-auto px-6 lg:px-12 grid md:grid-cols-2 gap-12 justify-center items-center">
                        {/* Left Content */}
                        ...
                        >
                            ...
                            <h2 className="text-4xl md:text-5xl font-medium mb-6 leading-tight">
                                Built for <span className="bg-gradient-to-r from-purple-300 to-purple-600 bg-clip-text text-transparent">modern creators</span> and teams
                            </h2>
                            <p className="text-white opacity-50 text-lg leading-relaxed mb-6">
                                From solo writers to product squads, Chat AI streamlines ideation, drafting and research into a single elegant flow.
                                We’re building tools that are fast, intuitive, and designed with privacy in mind.
                            </p>
                        </motion.div>
                    </div>
                </section>
                    ...
                    <div className="max-w-3xl mx-auto px-4">
                        ...
                        <Accordion type="single" collapsible className="rounded-2xl px-3 border">
                            ...
                            <AccordionItem value="item-1">
                                ...
                                <AccordionContent>
                                    We offer a generous free plan for individuals and paid plans for teams who need advanced collaboration and governance.
                                </AccordionContent>
                            </AccordionItem>
                            ...
                            <AccordionItem value="item-2">
                                ...
                                <AccordionContent>
                                    Your data is encrypted at rest and never sold. You control sharing per project. See our privacy page for full details.
                                </AccordionContent>
                            </AccordionItem>
                            ...
                            <AccordionItem value="item-3">
                                ...
                                <AccordionContent>
                                    Yes. Configure model providers in settings to use your own keys and preferences.
                                </AccordionContent>
                            </AccordionItem>
                            ...
                            <AccordionItem value="item-4">
                                ...
                                <AccordionContent>
                                    Absolutely! Invite teammates, assign roles, and collaborate in real-time with version control and project history.
                                </AccordionContent>
                            </AccordionItem>

                            <AccordionItem value="item-5">
                                <AccordionTrigger>What platforms does Chat AI integrate with?</AccordionTrigger>
                                <AccordionContent>
                                    We integrate with tools like Slack, Notion, Google Docs, and GitHub, making it easy to fit into your existing workflow.
                                </AccordionContent>
                            </AccordionItem>

                            <AccordionItem value="item-6">
                                <AccordionTrigger>Is there a mobile version available?</AccordionTrigger>
                                <AccordionContent>
                                    Yes! Chat AI works seamlessly on web, tablet, and mobile devices, so you can stay productive anywhere.
                                </AccordionContent>
                            </AccordionItem>

                            <AccordionItem value="item-7">
                                <AccordionTrigger>Can I customize the AI’s tone or style?</AccordionTrigger>
                                <AccordionContent>
                                    Definitely. You can set custom writing styles, tones, and even brand voice preferences to match your needs.
                                </AccordionContent>
                            </AccordionItem>
                            ...
                            <AccordionItem value="item-8">
                                ...
                                <AccordionContent>
                                    You can reach out via our in-app live chat or email us at support@chatai.com. We aim to respond within 24 hours.
                                </AccordionContent>
                            </AccordionItem>
